...
<span class="report_Dwn"> <input type="button" value="报表下载" id="reportDown"></span>
...
<input type="button" value="跑批任务"></div>
</div>
...
<input type="button" value="取消" class="upt_cancl">
 ...
 <div class="reporCont">
<form action="reportUp" method="post" enctype="multipart/form-data" onsubmit="return exreport()">
